            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="section-title">
                        <h1><span>Here From Our Satisfied Customers Say</span></h1>
                    </div>
                    <div class="testimonial-carousel-wrapper owl-carousel owl-theme">
                        <div class="item">
                            <div class="single-testimonial-carousel">
                                ...
                                <div class="testimonial-text-box">
                                    ...
                                    <p>Simtech Empire has been amazing,their response time and pricing are great and they have saved me from having to purchase a new trademill </p>
                        ...
                        <div class="item">
                            <div class="single-testimonial-carousel">
                                ...
                                <div class="testimonial-text-box">
                                    <h3>Am Thankful</h3>
                                    <p>Thank you for your quick services.In fact extremely fast.The Replacement part was perfect.Am now up and running </p>
                                    <span class="name">Chebet</span>
                                    <div class="review-box">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="item">
                            <div class="single-testimonial-carousel">
                                ...
                                <div class="testimonial-text-box">
                                    ...
                                    <p>Fantastic service kind regards.Thank you. </p>
                                    <span class="name">Peter Omollo</span>
                                    <div class="review-box">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
